...
import (
	...
	"snippetbox.claumann.net/internal/models/mocks"
)
...
func extractCSRFToken(t *testing.T, body string) string {
	...
	// The CSRF token is a base64 encoded string it will potentially include the + character, and this will be escaped to &#43;.
	// Use html.UnescapeString() to get the original token value.
